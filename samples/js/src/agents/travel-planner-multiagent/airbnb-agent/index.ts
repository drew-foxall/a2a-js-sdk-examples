...
import { getAirbnbMCPTools, setupMCPShutdownHandlers } from "./mcp-client.js";
...
async function main() {
  ...
  const requestHandler = new DefaultRequestHandler(airbnbAgentCard, taskStore, agentExecutor);
