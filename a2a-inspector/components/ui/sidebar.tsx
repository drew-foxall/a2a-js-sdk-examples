// @ts-nocheck
// shadcn/ui sidebar component - type checking disabled due to strictness incompatibility
"use client";
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: shadcn component design
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: shadcn component design
